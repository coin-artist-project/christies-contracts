...
contract F473Tokens is ERC1155Enumerable, ReentrancyGuard, Ownable
{
	...
	constructor(
		...
		string memory _previewImageBaseUrl
	)
		ERC1155(_animationBaseUrl)
		Ownable()
	{
		animationBaseUrl = _animationBaseUrl;
		previewImageBaseUrl = _previewImageBaseUrl;
	}
	...
	function setPreviewImageBaseUri(
		string calldata _uri
	)
		external
		onlyOwner
	{
		previewImageBaseUrl = _uri;
	}
